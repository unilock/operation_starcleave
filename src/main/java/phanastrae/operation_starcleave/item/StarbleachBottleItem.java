...
public class StarbleachBottleItem extends Item {
    ...
    public static final FoodComponent STARBLEACH_BOTTLE = new FoodComponent.Builder().nutrition(12).saturationModifier(5F).statusEffect(new StatusEffectInstance(OperationStarcleaveStatusEffects.STARBLEACHED_INSIDES, 6000, 5), 1).alwaysEdible().build();
}
